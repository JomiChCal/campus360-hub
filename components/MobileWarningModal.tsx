    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            <div className="relative overflow-hidden bg-gradient-to-br from-[#004270] via-[#003358] to-[#002d4d] px-8 pt-10 pb-12 text-center">
              ...
              <div className="relative mx-auto mb-5 flex h-20 w-20 items-center justify-center rounded-2xl bg-white/15 shadow-inner">
            ...
            <div className="space-y-5 px-7 pt-7 pb-1">
              <div className="flex items-start gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-utpl-surface">
                  <Monitor className="h-6 w-6 text-utpl-blue" />
                </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 pt-1">
                  ...
                  <p className="mt-1 text-sm leading-relaxed text-utpl-muted">
                    Durante la asesoría, tu asesor podría pedirte compartir pantalla para guiarte en
                    trámites, lo cual es limitado en dispositivos móviles.
                  </p>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-amber-200 bg-amber-50/60 px-5 py-4">
                <p className="text-sm leading-relaxed text-amber-800">
                  Puedes continuar desde tu celular, pero ten en cuenta que la atención podría no
                  ser tan eficiente.
                </p>
              </div>
            </div>

            <div className="flex flex-col gap-3 px-7 pt-4 pb-7">
              <motion.button
                type="button"
